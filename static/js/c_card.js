  ...
  methods: {
    ...
    async getThisUserPosts() {
      ...
      return await this.$api
        .$get(`users/${this.$route.params.id}/posts/?type=post`)
        .then((response) => {
          this.posts = response;
        })
        .catch((error) => {
    ...
    async unfollowThisPerson() {
      return await this.$api
        .$post(`/unfollow-user/`, { id: this.$route.params.id })
        .then((response) => {
          if (response !== null) {
    ...
    async followThisPerson() {
      return await this.$api
        .$post(`/follow-user/`, { id: this.$route.params.id })
        .then((response) => {
          if (response !== null) {
            this.$parent.viewusedata();
          }
    ...
    async getThisPersonFollowers() {
      return await this.$api
        .$get(`users/${this.$route.params.id}/follows/`)
        .then((response) => {
          if (response !== null) {
    ...
    async getThisPersonFollowings() {
      return await this.$api
        .$get(`users/${this.$route.params.id}/following/`)
        .then((response) => {
          if (response !== null) {
    ...
    async rateThisPersonLanderProfile() {
      ...
      return (await this.userdata.lender_profile.my_rating)
        ? this.$api.$patch(
            `/lender-profile-ratings/${this.$route.params.id}/`,
            rate_dta
          )
        : this.$api
            .$post(`/lender-profile-ratings/`, rate_dta)
            .then((response) => {
              if (response !== null) {
                this.$parent.viewusedata();
              }
